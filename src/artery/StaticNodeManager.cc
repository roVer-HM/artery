...
// emitted signals
const simsignal_t StaticNodeManager::addRoadSideUnitSignal = registerSignal("addRoadSideUnit");
...
void StaticNodeManager::handleMessage(cMessage* msg)
{
...
void StaticNodeManager::receiveSignal(cComponent* src, simsignal_t signal, const SimTime&, cObject*)
{
