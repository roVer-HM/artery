...
// TODO: Calculate simple Version of TTC to ITS-S in received DENM
int CollisionRiskService::calcTTC(vanetza::asn1::Denm& message)
{
    return 0;
}

// TODO: Initiate braking via the mVehicleController!
