...
const std::map<MovingNodeDataProvider::AngularAcceleration, double> MovingNodeDataProvider::mConfidenceTable {
...
MovingNodeDataProvider::MovingNodeDataProvider() :
        MovingNodeDataProvider(rand()){}


MovingNodeDataProvider::MovingNodeDataProvider(uint32_t id) :
...
void MovingNodeDataProvider::update(const traci::MovingNodeController* controller)
{
...
double MovingNodeDataProvider::mapOntoConfidence(AngularAcceleration x) const
{
...
void MovingNodeDataProvider::setStationType(StationType type)
{
    mStationType = type;
}

auto MovingNodeDataProvider::getStationType() const -> StationType
{
    return mStationType;
}
